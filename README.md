![Nøsted logo](https://github.com/Prosjekt2023/ProjectReficio/raw/main/wwwroot/nlogo.png)
...
```
6. Lag en samsvarende tabeller for din webapplikasjon. Hentet fra CreateDB.sql:
```
